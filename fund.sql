...
INSERT INTO `fund_info` VALUES ('000961','tianhong','指数型','天弘沪深300指数型发起式证券投资基金',' 天弘基金管理有限公司','张子法 陈瑶女士'),('001542','guotai','\t股票型','国泰互联网+股票型证券投资基金','中国建设银行股份有限公司','彭凌志 ');
...
CREATE TABLE `fund_net_unit` (
  ...
  `date` date DEFAULT '0000-00-00' COMMENT '时间',
  `unit_value` decimal(7,4) DEFAULT NULL COMMENT '单位净值',
  `unit_change` decimal(7,4) NOT NULL DEFAULT '0.0000',
  PRIMARY KEY (`id`),
